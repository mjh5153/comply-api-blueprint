...
public class WebContent {
    public static void main(String[] args) {
        try {
            ...
            URL url = new URL("https://jsonplaceholder.typicode.com/todos?id=5"); // returns title, id, userId, completed
            URLConnection urlConnection = url.openConnection(); // content type application/ json, URF-8

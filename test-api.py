...
"""
Spring Boot REST API Test Suite with Console JSON Output
Tests all 12 endpoints and displays formatted JSON responses
"""
...
def start_server():
    ...
    try:
        ...
        try:
            response = requests.get(f"{BASE_URL}/companys", timeout=5)
